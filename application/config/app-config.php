...
*
*/
define('APP_BASE_URL', 'http://localhost:90/crm/');
...
*/
define('APP_ENC_KEY', 'dfe8327a585d1527c6acd5a3195926fb');

/**
 * Database Credentials
 * The hostname of your database server
 */
define('APP_DB_HOSTNAME', 'cpp-crm.csmts6n9emkr.eu-west-2.rds.amazonaws.com');
 ...
 */
define('APP_DB_PASSWORD', 'Uk3y67yOArzcSSV');

/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'cpp_crm');
